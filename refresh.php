<?php include "/opt/lampp/htdocs/password/layout/header.php";?>
    ...
    <body>
    <br>
    <h2 class="col-md-offset-3 col-md-5">Try for Refresh TB</h2>
    <form name ="myForm"  action="https://localhost/oauth2/token" method="POST" enctype="application/x-www-form-urlencoded" class="col-md-offset-3 col-md-5">
        ...
        <div class="form-group">
            ...
            <div> <input type="text" name="refresh_token" class="form-control" placeholder="refresh_token_id" ></br> </div>
